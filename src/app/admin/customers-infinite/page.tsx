...
export default function CustomersPage() {
  ...
  const handleGetAllCustomers = React.useCallback(async () => {
    try {
      ...
      setListCustomers([...listCustomers, ...response])
      setPage(page + 1)
    } catch (error) {
  ...
  }, [page, setListCustomers, listCustomers])
    ...
    <main className="mb-40">
      ...
      <section id="TABLE-CUSTOMERS" className="px-6">
        <Table aria-label="Tabela com dados de clientes">
          ...
          >
            <InfiniteScroll
              dataLength={listCustomers.length} // This is important field to render the next data
              next={handleGetAllCustomers}
              hasMore={true}
              loader={<h4>Loading...</h4>}
              endMessage={
                <p style={{ textAlign: 'center' }}>
                  <b>Sim! Não tem mais registros...</b>
                </p>
              }
            >
